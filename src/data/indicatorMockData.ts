...
export const mockIndicators: Indicator[] = [
  ...
  // 1.0 品牌占目标市场份额
  {
    ...
    name: '立普妥占目标市场份额',
    category: 'result',
    description: '立普妥在目标市场中的份额占比',
    calculationMethod: '全渠道立普妥销售患者人天/全渠道血脂目标市场患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取全渠道立普妥销售患者人天和全渠道血脂目标市场患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '目标市场', '结果指标', '核心指标'],
  ...
  },
  {
    ...
    name: '立普妥占他汀份额',
    category: 'result',
    description: '立普妥在他汀类药物市场中的份额',
    calculationMethod: '全渠道立普妥销售患者人天/全渠道他汀Class患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取全渠道立普妥销售患者人天和全渠道他汀Class患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 1.1 影响型医院
  {
    ...
    name: '核心影响型医院渗透率',
    category: 'process',
    description: '核心影响型医院中已使用立普妥的比例',
    calculationMethod: '核心影响型医院销售患者人天/核心影响型医院潜力',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取核心影响型医院销售患者人天，除以核心影响型医院潜力',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '影响型医院', '渗透率', '过程指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '目标影响型医院渗透率',
    category: 'process',
    description: '目标影响型医院中已使用立普妥的比例',
    calculationMethod: '目标影响型医院销售患者人天/目标影响型医院潜力',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取目标影响型医院销售患者人天，除以目标影响型医院潜力',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '影响型医院', '渗透率', '过程指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
  ...
  // 1.11 准入
  {
    ...
    name: '准入医院比例',
    category: 'process',
    description: '已准入（动销）的影响型医院占影响型医院总数的比例',
    calculationMethod: '动销(毛销售额>0)影响型医院/影响型医院数量',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取动销（毛销售额>0）的影响型医院数量，除以影响型医院总数（影响型医院包括:城市/县域公立二三级）',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '准入', '影响型医院', '过程指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 1.12 解限
  {
    id: 'ind-lipitor-6',
    name: 'AA/AB+医院比率(核心影响型医院内)',
    category: 'process',
    description: '核心影响型医院中AA及AB+医院的比例',
    calculationMethod: 'AA及AB+医院数量/全部核心影响型医院数量',
    dataSource: '内部医院分级数据',
    dataLogic: '从医院分级系统提取AA及AB+医院数量，除以全部核心影响型医院数量',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '解限', '影响型医院', '过程指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 1.13 稳定分销
  {
    ...
    name: '核心影响型医院稳定分销率',
    category: 'process',
    description: '核心影响型医院中保持稳定分销的比例（稳定分销定义为每季度立普妥销量>100盒）',
    calculationMethod: '立普妥稳定分销医院家数/核心影响型医院总数',
    dataSource: '内部分销数据',
    dataLogic: '从分销系统提取立普妥稳定分销医院家数（每季度立普妥销量>100盒），除以核心影响型医院总数',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '稳定分销', '影响型医院', '过程指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 1.2 医院
  {
    ...
    name: '医院渠道立普妥占目标市场份额',
    category: 'result',
    description: '医院渠道中立普妥在目标市场中的份额',
    calculationMethod: '医院渠道立普妥销售患者人天/医院渠道血脂目标市场患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取医院渠道立普妥销售患者人天和医院渠道血脂目标市场患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '医院渠道', '目标市场', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '医院渠道立普妥占他汀份额',
    category: 'result',
    description: '医院渠道中立普妥在他汀类药物市场中的份额',
    calculationMethod: '医院渠道立普妥销售患者人天/医院渠道他汀Class患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取医院渠道立普妥销售患者人天和医院渠道他汀Class患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '医院渠道', '他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-10',
    name: '医院渠道阿托伐他汀占目标市场份额',
    category: 'result',
    description: '医院渠道中阿托伐他汀在目标市场中的份额',
    calculationMethod: '医院渠道阿托伐他汀/他汀Class患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取医院渠道阿托伐他汀患者人天和医院渠道他汀Class患者人天，计算占比',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '医院渠道', '阿托伐他汀', '结果指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-11',
    name: '医院渠道立普妥占阿托伐他汀份额',
    category: 'result',
    description: '医院渠道中立普妥在阿托伐他汀市场中的份额',
    calculationMethod: '医院渠道立普妥/阿托伐他汀患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取医院渠道立普妥患者人天和医院渠道阿托伐他汀患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '医院渠道', '阿托伐他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '公立基层渗透率',
    category: 'process',
    description: '公立基层医院中已使用立普妥的比例',
    calculationMethod: '过去3个月内动销/基层医院数量',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取过去3个月内动销的基层医院数量，除以基层医院总数',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '公立基层', '渗透率', '过程指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '民营覆盖率',
    category: 'process',
    description: '民营医院中已覆盖立普妥的比例',
    calculationMethod: '过去3个月内动销/民营医院数量',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取过去3个月内动销的民营医院数量，除以民营医院总数',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '民营', '覆盖率', '过程指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 1.3 零售
  {
    ...
    name: '零售渠道立普妥占目标市场份额',
    category: 'result',
    description: '零售渠道中立普妥在目标市场中的份额',
    calculationMethod: '零售渠道立普妥销售患者人天/零售渠道血脂目标市场患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道立普妥销售患者人天和零售渠道血脂目标市场患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '零售渠道', '目标市场', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '零售渠道立普妥占他汀份额',
    category: 'result',
    description: '零售渠道中立普妥在他汀类药物市场中的份额',
    calculationMethod: '零售渠道立普妥/他汀Class患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道立普妥患者人天和零售渠道他汀Class患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '零售渠道', '他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-16',
    name: '零售渠道阿托伐他汀占目标市场份额',
    category: 'result',
    description: '零售渠道中阿托伐他汀在目标市场中的份额',
    calculationMethod: '零售渠道阿托伐他汀/他汀Class患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道阿托伐他汀患者人天和零售渠道他汀Class患者人天，计算占比',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '零售渠道', '阿托伐他汀', '结果指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-17',
    name: '零售渠道立普妥占阿托伐他汀份额',
    category: 'result',
    description: '零售渠道中立普妥在阿托伐他汀市场中的份额',
    calculationMethod: '零售渠道立普妥/阿托伐他汀患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道立普妥患者人天和零售渠道阿托伐他汀患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '零售渠道', '阿托伐他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-18',
    name: '零售渠道立普妥大包装(28s)占全部立普妥份额',
    category: 'result',
    description: '零售渠道中立普妥28片大包装在全部立普妥中的份额',
    calculationMethod: '零售渠道立普妥28片大包装销售患者人天/立普妥整体患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道立普妥28片大包装销售患者人天和立普妥整体患者人天，计算占比',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '零售渠道', '大包装', '结果指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    id: 'ind-lipitor-19',
    name: '立普妥10mg占阿托伐10mg份额',
    category: 'result',
    description: '零售渠道中立普妥10mg在阿托伐他汀10mg市场中的份额',
    calculationMethod: '零售渠道立普妥10mg患者人天/阿托伐他汀10mg患者人天',
    dataSource: 'IQVIA市场数据',
    dataLogic: '从IQVIA数据库提取零售渠道立普妥10mg患者人天和零售渠道阿托伐他汀10mg患者人天，计算占比',
    unit: '%',
    isCore: true,
    tags: ['立普妥', '零售渠道', '10mg', '阿托伐他汀', '结果指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  {
    ...
    name: '零售分销WD',
    category: 'process',
    description: '零售分销加权铺货率',
    calculationMethod: '零售分销加权铺货率WD',
    dataSource: '内部渠道数据',
    dataLogic: '从渠道管理系统提取零售分销加权铺货率WD',
    unit: '%',
    isCore: false,
    tags: ['立普妥', '零售渠道', '分销', '过程指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // ========== 2. 其他指标 ==========
  // 2.0 资源投入效率(ROI)
  {
    ...
    name: '资源投入效率(ROI)',
    category: 'efficiency',
    description: '资源投入与产出的效率比',
    calculationMethod: '终端购进毛销售额/(GTN+人力费用+推广费用)',
    dataSource: '财务数据 + 销售数据',
    dataLogic: '从财务系统提取GTN、人力费用、推广费用，从销售系统提取终端购进毛销售额，计算比值',
    unit: '倍',
    isCore: true,
    tags: ['资源投入', 'ROI', '效率指标', '核心指标'],
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  },
  // 3.0 非立络销售额占比
  {
    ...
    name: '非立络销售额占比',
    category: 'result',
    description: '非立普妥和络活喜产品销售额占全渠道产品销售额的比例',
    calculationMethod: '1-(立普妥+络活喜)终端购进毛销售额/全渠道产品终端购进毛销售额',
    dataSource: '内部销售数据',
    dataLogic: '从销售系统提取立普妥和络活喜终端购进毛销售额，以及全渠道产品终端购进毛销售额，计算占比',
    unit: '%',
    isCore: false,
    tags: ['非立络', '销售额', '结果指标'],
    createdAt: new Date('2024-01-01'),
