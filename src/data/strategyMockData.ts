...
export const mockOpportunities: Opportunity[] = [
  {
    id: 'opp1',
    title: '立普妥-零售',
    description: '立普妥零售市场分子式份额落后可定，10mg大包装分销水平低',
    marketSegment: '零售渠道-立普妥',
    currentGap: '立普妥零售市场分子式份额落后可定，10mg大包装分销水平低',
    potential: 'high',
  ...
  },
  {
    id: 'opp2',
    title: '络活喜-院内',
    description: '氨氯地平院内份额下降，主要是在心内科合并并发症以及肾内科的理论优势受到硝苯地平侵蚀',
    marketSegment: '院内-络活喜',
    currentGap: '氨氯地平院内份额下降，主要是在心内科合并并发症以及肾内科的理论优势受到硝苯地平侵蚀',
    potential: 'high',
  ...
  },
  {
    id: 'opp3',
    title: 'Non-cv产品',
    description: '当前cv产品占比持续提升，non-cv产品销售占比仍处于较低水平',
    marketSegment: 'Non-cv产品',
    currentGap: '当前cv产品占比持续提升，non-cv产品销售占比仍处于较低水平',
    potential: 'high',
